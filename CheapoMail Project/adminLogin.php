<html>
<head>
	<title>Cheapo Mail | Administrator Login</title>
...
<body>
	...
	<?php
	// Prevents wrong data from being entered into database.
	...
	$findAdminStatus = "";
		...
		{
			$isAdmin = FALSE;
			$findAdminStatus = "<br/><li class='status' id='error'>  User is not an Administrator. </li>";
		}
	...
	//user&password validation statement
