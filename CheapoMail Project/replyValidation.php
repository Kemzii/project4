...
?>
	...
	if($sender != "" && $recipient != "" && $subject != "" && $message != ""){
		...
		$statusEmpty = "<br/><li class='status' id='error'>All fields are required.</li>";
	}
	?>
	...
	if($senderArray != 0){
		...
		$statusSender = "<br/><li class='status' id='error'>That sender is not a registered Cheapo Mail user.</li>";
	}
